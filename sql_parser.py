...
class DB:
    ...
    def query(self, name_table_mapping, conditions):
    ...
    def execute(self, sql):
        ...
        if type(token).__name__ == 'Token' and str(token).upper() == 'INSERT':
            ...
            return self.select_from(parsed)
    ...
    def select_from(self, parsed):
        ...
        res_with_all_col = self.query(join_table_mapping, conditions)
